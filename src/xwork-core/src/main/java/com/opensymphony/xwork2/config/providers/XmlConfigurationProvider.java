        ...
        for (Document doc : documents) {
            ...
            for (int i = 0; i < childSize; i++) {
                ...
                if (childNode instanceof Element) {
                    ...
                    System.out.println("====================struts配置文件解析，nodeName："+nodeName);
                    if ("bean".equals(nodeName)) {
                        ...
                        System.out.println("====================struts配置文件解析，childNode,type："+type+",name:"+name+",class:"+impl+",static:"+onlyStatic+",scope:"+scopeStr);
