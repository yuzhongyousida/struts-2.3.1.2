...
public abstract class LoggerFactory {
    ...
    /**
     * 1、如果web.xml 配置了“loggerFactory”参数属性，且初始化正常，则用配置的loggerFactory
     * 2、如果没有web.xml 没有配置“loggerFactory”参数(即factory属性为空)，则尝试org.apache.commons.logging.LogFactory
     * 3、如果失败 使用JdkLoggerFactory
     * @return
     */
