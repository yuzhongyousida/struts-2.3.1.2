...
public class DefaultConfiguration implements Configuration {
    ...
    public synchronized List<PackageProvider> reloadContainer(List<ContainerProvider> providers) throws ConfigurationException {
        ...
        ContainerProperties props = new ContainerProperties();// 保存struts常量
        ...
        for (final ContainerProvider containerProvider : providers) {
             ...
             * 处理完成之后Document会保存到XmlConfigurationProvider类的documents list集合中
             * include file路径会保存到XmlConfigurationProvider类的loadedFileUrls set集合中
        ...
        /**
         * 将struts的常量配置保存到ContainerBuilder#factories map集合中
